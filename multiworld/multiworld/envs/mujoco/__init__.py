...
def register_mujoco_envs():
    ...
    Multi-object tasks
    """
    from multiworld.envs.mujoco.sawyer_xyz.multiobject \
        import sawyer_push_multiobj

    def register_multiobject_spec(name, version, spec, **kwargs):
        for key, description in spec.items():
            register(
                id='{}-{}-{}'.format(name, key, version),
                entry_point='multiworld.envs.mujoco.sawyer_xyz.multiobject'
                            '.sawyer_push_multiobj:SawyerMultiobjectPushEnv',
                kwargs=dict(n_objects=description.n_objects,
                            color_set=description.color_set,
                            randomize_object_init=description.random_init,
                            object_fixed_init_pos=description.init_pos,
                            objects_goal_low=description.goals_low,
                            objects_goal_high=description.goals_high,
                            stable_objects=description.stable_objects,
                            connections=description.connections,
                            **kwargs))

    Desc = namedtuple('Desc', ('n_objects color_set random_init init_pos '
                               'goals_low goals_high stable_objects connections'))
    Desc.__new__.__defaults__ = (1, sawyer_push_multiobj.COLOR_SET_16,
                                 True, None, (-0.2, 0.45), (0.2, 0.7), (), ())

    # Old Push env, kept for backwards compatibility
    multiobject_push_specification_v0 = {
        'ZeroObj': Desc(0),
        'OneObj': Desc(1),
        'TwoObj': Desc(2),
        'ThreeObj': Desc(3),
        ...
        'FiveObj': Desc(5),
        'SixObj': Desc(6),
        'ZeroToThreeObj': Desc((0, 3)),
        'OneToThreeObj': Desc((1, 3)),
        'OneToFourObj': Desc((1, 4)),
        'OneToFiveObj': Desc((1, 5)),
        'OneToSixObj': Desc((1, 6)),

    }
    register_multiobject_spec('SawyerMultiobjectPushEnv', 'v0',
                              multiobject_push_specification_v0)

    # Objects have fixed initial position
    multiobject_push_specification_v1 = {
        'OneObj': Desc(1, sawyer_push_multiobj.COLOR_SET_BGR,
                       False, [[0, 0.55]]),
        'TwoObj': Desc(2, sawyer_push_multiobj.COLOR_SET_BGR,
                       False, [[-0.075, 0.55], [0.075, 0.55]]),
        'ThreeObj': Desc(3, sawyer_push_multiobj.COLOR_SET_6,
                         False, [[-0.14, 0.5], [0.0, 0.5], [0.14, 0.5]])
    }
    register_multiobject_spec('SawyerMultiobjectPushEnv', 'v1',
                              multiobject_push_specification_v1,
                              randomize_object_colors=False)

    # Objects have fixed initial position, goal space in front,
    # goal space separated for two objects
    multiobject_push_specification_v2 = {
        'OneObj': Desc(1, sawyer_push_multiobj.COLOR_SET_BGR,
                       False, [[0, 0.52]], (-0.2, 0.52), (0.2, 0.7)),
        'TwoObj': Desc(2, sawyer_push_multiobj.COLOR_SET_BGR,
                       False, [[-0.1, 0.5], [0.1, 0.5]],
                       [[-0.2, 0.5], [0.0, 0.5]],
                       [[0.0, 0.7], [0.2, 0.7]]),
        'ThreeObj': Desc(3, sawyer_push_multiobj.COLOR_SET_6,
                         False, [[-0.14, 0.5], [0.0, 0.5], [0.14, 0.5]],
                         [[-0.2, 0.5], [-0.07, 0.5], [0.07, 0.5]],
                         [[-0.07, 0.7], [0.07, 0.7], [0.2, 0.7]])
    }
    register_multiobject_spec('SawyerMultiobjectPushEnv', 'v2',
                              multiobject_push_specification_v2,
                              randomize_object_colors=False)

    multiobject_rearrange_specification_v0 = {
        'OneObj': Desc(1, sawyer_push_multiobj.COLOR_SET_BGR),
        'TwoObj': Desc(2, sawyer_push_multiobj.COLOR_SET_BGR),
        'ThreeObj': Desc(3, sawyer_push_multiobj.COLOR_SET_6),
        'FourObj': Desc(4, sawyer_push_multiobj.COLOR_SET_6),
        'FiveObj': Desc(5, sawyer_push_multiobj.COLOR_SET_6),
        'SixObj': Desc(6, sawyer_push_multiobj.COLOR_SET_6),
        'ThreeObjFirstStable': Desc(3, sawyer_push_multiobj.COLOR_SET_6, stable_objects = [0]),
         'FourObjFirstStable': Desc(4, sawyer_push_multiobj.COLOR_SET_6, stable_objects = [0]),
         'FiveObjFirstStable': Desc(5, sawyer_push_multiobj.COLOR_SET_6, stable_objects = [0]),
          'SixObjFirstStable': Desc(6, sawyer_push_multiobj.COLOR_SET_6, stable_objects = [0]),        
        'ThreeObjFirstStableCon2to3': Desc(3, sawyer_push_multiobj.COLOR_SET_6, stable_objects = [0], connections = [(1,2)]),
         'FourObjFirstStableCon2to3': Desc(4, sawyer_push_multiobj.COLOR_SET_6, stable_objects = [0], connections = [(1,2)]),
         'FiveObjFirstStableCon2to3': Desc(5, sawyer_push_multiobj.COLOR_SET_6, stable_objects = [0], connections = [(1,2)]),
          'SixObjFirstStableCon2to3': Desc(6, sawyer_push_multiobj.COLOR_SET_6, stable_objects = [0], connections = [(1,2)]),
    }
    register_multiobject_spec('SawyerMultiobjectRearrangeEnv', 'v0',
                              multiobject_rearrange_specification_v0,
                              randomize_object_colors=False)

    multiobject_rearrange_rand_colors_spec_v0 = {
        'OneOfThreeObj': Desc(1, sawyer_push_multiobj.COLOR_SET_3),
        'TwoOfThreeObj': Desc(2, sawyer_push_multiobj.COLOR_SET_3),
    }
    register_multiobject_spec('SawyerMultiobjectRearrangeEnv', 'v0',
                              multiobject_rearrange_rand_colors_spec_v0,

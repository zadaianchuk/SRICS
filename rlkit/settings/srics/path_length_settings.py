...
_PATH_CONFIGS = {
    ...
    'MOURL-Rearrange-5obj': _PathConf(6, subtask_len=20),
    'MOURL-Rearrange-6obj': _PathConf(7, subtask_len=20),
    'MOURL-Rearrange-7obj': _PathConf(8, subtask_len=20),
    'MOURL-Rearrange-8obj': _PathConf(9, subtask_len=20),
